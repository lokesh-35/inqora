...
export const ConsensusMeter: React.FC<ConsensusMeterProps> = ({
      ...
      if (match) {
        ...
        return (
          <button
            ...
            className="inline-flex items-center justify-center px-1.5 py-0.5 mx-0.5 font-mono text-[11px] font-semibold text-[#163A35] bg-[#EBF2F0] hover:bg-[#D9E4E0] border border-[#D9DEDA] rounded transition-colors align-baseline cursor-pointer"
          >
            {part}
          </button>
        );
  ...
  return (
    <div className="bg-white rounded-xl border border-[#D9DEDA] overflow-hidden shadow-xs">
      {/* Editorial Header Section */}
      <div className="px-6 py-5 border-b border-[#D9DEDA] bg-[#FAF9F5]">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="space-y-1 max-w-2xl">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#D9DEDA]">&bull;</span>
            ...
            <h2 className="text-lg sm:text-xl font-heading font-semibold text-[#163A35] leading-snug">
          ...
          <div className="flex items-center gap-2.5 shrink-0 self-start md:self-auto">
            <button
              type="button"
              onClick={handleCopy}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#202624] bg-white border border-[#D9DEDA] hover:bg-[#F7F6F2] rounded-lg transition-colors cursor-pointer"
        ...
        <div className="mt-5 space-y-2.5">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-mono text-xs text-[#202624] font-medium">
              Prevailing: <span className="font-semibold text-[#163A35]">{prevailingStatus}</span>
            </span>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="border-l-3 border-[#163A35] pl-4 py-1 bg-[#F9F6F0] p-4 rounded-r-lg">
          <div className="text-[11px] font-mono uppercase tracking-wider text-[#68736F] mb-1">
            Consensus Summary
          </div>
          <p className="text-sm font-medium text-[#163A35] leading-relaxed">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-[#2F6F68] hover:text-[#163A35] font-medium inline-flex items-center gap-1 cursor-pointer"
            >
        ...
        {showStudyBreakdown && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-[#D9DEDA] text-xs">
            <div className="bg-[#FAF9F5] p-3.5 rounded-lg border border-[#D9DEDA]">
              <span className="text-[#68736F] block text-[11px]">Primary Studies</span>
              <span className="font-mono text-sm font-semibold text-[#163A35]">{papers.length} Papers</span>
            </div>
            <div className="bg-[#FAF9F5] p-3.5 rounded-lg border border-[#D9DEDA]">
            ...
            <div className="bg-[#FAF9F5] p-3.5 rounded-lg border border-[#D9DEDA]">
              ...
              <span className="font-mono text-xs font-semibold text-[#163A35]">{prevailingStatus}</span>
            </div>
            <div className="bg-[#FAF9F5] p-3.5 rounded-lg border border-[#D9DEDA]">
        ...
        {onAskFollowUp && (
          <div className="pt-4 border-t border-[#D9DEDA] flex flex-wrap items-center gap-2 text-xs">
            ...
            {[
              ...
              <button
                ...
                className="text-xs px-3 py-1 rounded-md bg-[#F7F6F2] text-[#202624] hover:text-[#163A35] hover:bg-[#EBF2F0] border border-[#D9DEDA] transition-colors cursor-pointer"
              >
                {fu} &rarr;
              </button>
            ))}
