...
export const ResearchWorkspace: React.FC<ResearchWorkspaceProps> = ({
  ...
  return (
    <div className="flex-1 min-h-screen bg-[#FAF8F5] flex flex-col">
      {/* Docked Academic Header Bar */}
      <header className="bg-[#FFFFFF] border-b border-[#FAF8F5] sticky top-0 z-30 px-4 sm:px-6 py-3 shadow-[0_1px_3px_rgba(22,58,53,0.02)]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            <button
              ...
              className="p-1.5 rounded text-[#4A5568] hover:text-[#431407] hover:bg-[#FAF8F5] transition-colors cursor-pointer border border-[#FAF8F5] shrink-0"
              title="Return to Inqora portal"
            >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="font-['DM_Sans'] text-sm sm:text-base font-bold text-[#431407] truncate">
                  {question || topic || 'Academic Literature Inquiry'}
                </span>
                <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-[#EFEFEA] text-[#431407] border border-[#FAF8F5] font-semibold shrink-0">
              ...
              <div className="text-[11px] text-[#6B7280] flex items-center gap-2 truncate mt-0.5">
                ...
                {uploadedFile && (
                  <span className="text-[#431407] bg-[#EFEFEA] px-1.5 py-0.5 rounded border border-[#FAF8F5] text-[10px]">
          ...
          <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
            {onOpenFilters && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium text-[#431407] bg-[#FFFFFF] hover:bg-[#FAF8F5] border border-[#FAF8F5] hover:border-[#D97706] transition-colors cursor-pointer shadow-2xs"
              >
            ...
            <button
              type="button"
              onClick={onBackToLanding}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded bg-[#D97706] hover:bg-[#431407] text-xs font-semibold text-white transition-colors cursor-pointer shadow-2xs"
            >
            ...
            {currentUser ? (
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded bg-[#EFEFEA] hover:bg-[#E4ECE9] border border-[#FAF8F5] text-xs text-[#431407] font-medium transition-colors cursor-pointer"
                title={`${currentUser.name} (${currentUser.institution}) - Institutional Access`}
              >
                <div className="w-5 h-5 rounded-full bg-[#431407] text-white flex items-center justify-center text-[10px] font-bold">
              ...
              onOpenAuth && (
                <button
                  ...
                  className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1.5 rounded border border-[#FAF8F5] hover:border-[#D97706] hover:bg-[#FFFFFF] text-xs text-[#431407] font-medium transition-colors cursor-pointer"
                >
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 flex-1 flex flex-col">
        ...
        <div className="bg-[#FFFFFF] border border-[#FAF8F5] rounded-[8px] p-1 shadow-2xs mb-6 overflow-x-auto scrollbar-none">
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-3 py-2 rounded text-xs font-medium transition-colors cursor-pointer ${
                    isActive
                      ? 'bg-[#431407] text-white shadow-2xs'
                      : 'text-[#4A5568] hover:bg-[#FAF8F5] hover:text-[#431407]'
                  }`}
                >
                  <Icon className={`w-3.5 h-3.5 ${isActive ? 'text-[#D97706]' : 'text-[#6B7280]'}`} />
        ...
        <div className="space-y-6 flex-1">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between pb-1 border-b border-[#FAF8F5]">
                  <h3 className="font-['DM_Sans'] text-sm font-bold text-[#431407] flex items-center gap-2">
          ...
          {activeTab === 'papers' && (
            <div className="space-y-4">
              <div className="bg-[#FFFFFF] border border-[#FAF8F5] rounded-[10px] p-4">
                <h3 className="font-['DM_Sans'] text-base font-bold text-[#431407]">
          ...
          {activeTab === 'limitations' && (
            <div className="space-y-6">
              <div className="bg-[#FFFFFF] border-l-2 border-[#D97706] border-y border-r border-[#FAF8F5] rounded-r-md p-4 flex items-start gap-3">
          ...
          {activeTab === 'directions' && (
            <div className="space-y-6">
              <div className="bg-[#FFFFFF] border-l-2 border-[#D97706] border-y border-r border-[#FAF8F5] rounded-r-md p-4 flex items-start gap-3">
                <Compass className="w-5 h-5 text-[#D97706] shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-['DM_Sans'] text-base font-bold text-[#431407]">
          ...
          {activeTab === 'chat' && (
            <div className="bg-[#FFFFFF] border border-[#FAF8F5] rounded-[10px] shadow-xs overflow-hidden">
              <ResearchChat
        ...
        <div className="mt-8 sticky bottom-4 z-20">
          <form
            ...
            className="w-full max-w-3xl mx-auto bg-[#FFFFFF] rounded-[10px] border border-[#FAF8F5] hover:border-[#D97706] focus-within:border-[#D97706] focus-within:shadow-[0_4px_16px_rgba(22,58,53,0.08)] shadow-sm p-2.5 sm:p-3 flex items-center gap-2 transition-all"
          >
            <input
              type="text"
              value={followUpInput}
            ...
            <button
              ...
              className="px-3 py-1.5 rounded bg-[#D97706] hover:bg-[#431407] disabled:bg-[#FAF8F5] disabled:text-[#9CA3AF] text-white text-xs font-medium flex items-center gap-1.5 transition-colors cursor-pointer shrink-0"
