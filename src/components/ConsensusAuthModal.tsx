...
export const ConsensusAuthModal: React.FC<ConsensusAuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#431407]/40 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-[#FFFFFF] rounded-[10px] border border-[#FAF8F5] shadow-2xl max-w-lg w-full overflow-hidden flex flex-col relative max-h-[92vh]">
        {/* Modal Close Button */}
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 rounded text-[#6B7280] hover:text-[#431407] hover:bg-[#FAF8F5] transition-colors cursor-pointer z-10"
        >
          <X className="w-5 h-5" />
        </button>

        {/* Modal Header */}
        <div className="p-6 pb-4 border-b border-[#FAF8F5] bg-[#FAF8F5] flex flex-col items-center text-center">
          <div className="flex items-center gap-2 mb-2">
            <ConsensusLogo size={32} />
            <span className="font-['DM_Sans'] text-base font-bold text-[#431407] tracking-tight">
              Inqora
            </span>
          </div>
          <h3 className="font-['DM_Sans'] text-lg sm:text-xl font-bold text-[#431407]">
        ...
        <div className="p-6 overflow-y-auto scrollbar-thin flex-1">
          ...
          {currentUser && !isSuccess ? (
            <div className="space-y-5">
              <div className="p-4 rounded-lg bg-[#FAF8F5] border border-[#FAF8F5] flex items-start gap-3">
                <div className="w-11 h-11 rounded-full bg-[#431407] text-white flex items-center justify-center font-semibold text-sm shrink-0">
                  {currentUser.name
                    ? currentUser.name
                        .split(' ')
                        .map((n) => n[0])
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <h4 className="font-['DM_Sans'] text-sm font-bold text-[#431407]">
                      {currentUser.name}
                    </h4>
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-[#E4ECE9] text-[#431407] border border-[#D97706]/20">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-center justify-between p-2.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
                  <span className="text-[#6B7280]">Academic Designation</span>
                  <span className="font-semibold text-[#431407]">{currentUser.role}</span>
                </div>
                {currentUser.orcid && (
                  <div className="flex items-center justify-between p-2.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
                    <span className="text-[#6B7280]">ORCID Record</span>
                    <span className="font-mono text-[11px] text-[#D97706] font-semibold">
                ...
                <div className="flex items-center justify-between p-2.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
                  ...
                  <span className="font-semibold text-[#431407] flex items-center gap-1">
              ...
              <div className="pt-3 border-t border-[#FAF8F5] flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-2 text-xs font-semibold text-white bg-[#D97706] hover:bg-[#431407] rounded transition-colors cursor-pointer shadow-2xs"
                >
                  Done
                </button>
              </div>
            ...
            /* Success Feedback */
            <div className="my-8 text-center py-6 bg-[#FAF8F5] rounded border border-[#FAF8F5] animate-in fade-in duration-200">
              <CheckCircle2 className="w-10 h-10 text-[#D97706] mx-auto mb-2.5" />
              <div className="text-sm font-semibold text-[#431407]">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 p-1 bg-[#FAF8F5] rounded-lg border border-[#FAF8F5] text-xs font-medium">
                <button
                  type="button"
                  onClick={() => setActiveTab('sso')}
                  className={`py-2 px-3 rounded-md transition-colors cursor-pointer flex items-center justify-center gap-1.5 ${
                    activeTab === 'sso'
                      ? 'bg-[#FFFFFF] text-[#431407] shadow-xs font-semibold'
                      : 'text-[#6B7280] hover:text-[#431407]'
                  }`}
                >
              ...
              {activeTab === 'sso' ? (
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-semibold text-[#431407] uppercase tracking-wider mb-2">
                    ...
                    <div className="space-y-2">
                      {INSTITUTIONAL_PARTNERS.map((inst) => (
                        <button
                          ...
                          className="w-full flex items-center justify-between p-3 rounded border border-[#FAF8F5] hover:border-[#D97706] hover:bg-[#FAF8F5] transition-colors text-left group cursor-pointer"
                        >
                          <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 rounded bg-[#EFEFEA] group-hover:bg-[#FFFFFF] flex items-center justify-center text-[#431407] font-bold text-xs border border-[#FAF8F5]">
                              {inst.name[0]}
                            </div>
                            <div>
                              <div className="text-xs font-semibold text-[#431407]">
                                {inst.name}
                              </div>
                          ...
                          <div className="flex items-center gap-1 text-xs text-[#D97706] font-medium group-hover:translate-x-0.5 transition-transform">
                            <span>Sign in</span>
                  ...
                  <div className="pt-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-xs border border-[#FAF8F5] rounded focus:outline-hidden focus:border-[#D97706]"
                      />
                      <button
                        type="button"
                        onClick={() =>
                        ...
                        className="px-4 py-2 bg-[#D97706] hover:bg-[#431407] text-white text-xs font-semibold rounded transition-colors shadow-2xs cursor-pointer"
                      >
                        SSO
                      </button>
                    </div>
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-3.5">
                  <div>
                    <label className="block text-xs font-medium text-[#431407] mb-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2 border border-[#FAF8F5] rounded text-xs text-[#242A29] placeholder:text-[#9CA3AF] focus:outline-hidden focus:border-[#D97706]"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-3 py-2 border border-[#FAF8F5] rounded text-xs text-[#242A29] focus:outline-hidden focus:border-[#D97706]"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-[#FAF8F5] rounded text-xs text-[#242A29] focus:outline-hidden focus:border-[#D97706] bg-[#FFFFFF]"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-[#FAF8F5] rounded text-xs text-[#242A29] focus:outline-hidden focus:border-[#D97706]"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-[#FAF8F5] rounded text-xs font-mono text-[#242A29] focus:outline-hidden focus:border-[#D97706]"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-2.5 rounded bg-[#D97706] hover:bg-[#431407] text-white text-xs font-semibold shadow-2xs transition-colors cursor-pointer mt-2"
                  >
              ...
              {/* Security Footnote */}
              <div className="pt-2 border-t border-[#FAF8F5] flex items-center justify-between text-[11px] text-[#6B7280]">
