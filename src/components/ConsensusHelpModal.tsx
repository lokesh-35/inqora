...
export const ConsensusHelpModal: React.FC<ConsensusHelpModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#431407]/40 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-[#FFFFFF] rounded-[10px] border border-[#FAF8F5] shadow-2xl max-w-xl w-full overflow-hidden flex flex-col max-h-[85vh]">
        {/* Header */}
        <div className="px-6 py-4 border-b border-[#FAF8F5] flex items-center justify-between bg-[#FAF8F5]">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-['DM_Sans'] text-base font-semibold text-[#431407]">
              Inqora Methodology &amp; Evidence Guide
            </h3>
          </div>
          <button
            type="button"
        ...
        <div className="p-6 overflow-y-auto space-y-5 text-xs text-[#242A29] scrollbar-thin">
          <div className="p-4 bg-[#FAF8F5] border-l-2 border-[#D97706] border-y border-r border-[#FAF8F5] rounded-r-md">
            <div className="font-['DM_Sans'] font-semibold text-[#431407] flex items-center gap-1.5 mb-1 text-sm">
              <BookOpen className="w-4 h-4 text-[#D97706]" />
              <span>Academic Evidence Discovery Platform</span>
            </div>
            <p className="text-[#4A5568] leading-relaxed">
              Inqora synthesizes evidence across 220M+ peer-reviewed papers from Semantic Scholar, arXiv, and Crossref, directly extracting methodologies, sample sizes, empirical findings, and author-reported limitations.
            </p>
          </div>

          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
              <Scale className="w-4 h-4 text-[#D97706] shrink-0 mt-0.5" />
              <div>
                <h4 className="font-['DM_Sans'] font-semibold text-[#431407] text-xs">Scientific Consensus Meter</h4>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
              <FileSpreadsheet className="w-4 h-4 text-[#D97706] shrink-0 mt-0.5" />
              <div>
                <h4 className="font-['DM_Sans'] font-semibold text-[#431407] text-xs">Scholarly Literature Review Matrix</h4>
                <p className="text-[#4A5568] mt-0.5 leading-relaxed">
            ...
            <div className="flex items-start gap-3 p-3.5 rounded border border-[#FAF8F5] bg-[#FFFFFF]">
              ...
              <div>
                <h4 className="font-['DM_Sans'] font-semibold text-[#431407] text-xs">Empirical Research Gaps Engine</h4>
                <p className="text-[#4A5568] mt-0.5 leading-relaxed">
          ...
          <div className="pt-3 border-t border-[#FAF8F5] flex items-center justify-between text-[#6B7280]">
            <span className="font-mono text-[11px]">Explore. Compare. Discover.</span>
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-1.5 rounded bg-[#431407] text-white font-medium hover:bg-[#D97706] transition-colors cursor-pointer text-xs"
            >
              Close Guide
            </button>
          </div>
